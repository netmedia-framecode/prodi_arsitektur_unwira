    ...
    <tbody>
      <tr>
        ...
        <td style="text-align: center;">
          <h3>LAPORAN PREDIKSI LAMA STUDI MAHASISWA<br>LULUS TEPAT DAN TIDAK TEPAT<br>PROGRAM STUDI ARSITEKTUR UNWIRA</h3>
        </td>
      </tr>
    </tbody>
  </table>
...
<table border="0" style="width: 100%;margin-top: 10px;vertical-align: top;">
  ...
  <tbody>');
    $data_prediksi = mysqli_query($conn, "SELECT * FROM data_testing ORDER BY id_testing DESC");
