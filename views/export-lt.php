...
$mpdf = new \Mpdf\Mpdf();
$mpdf->SetTitle("Laporan Prediksi Lama Studi Mahasiswa Lulus Tepat");
    ...
    <tbody>
      <tr>
        ...
        <td style="text-align: center;">
          <h3>LAPORAN PREDIKSI LAMA STUDI MAHASISWA<br>LULUS TEPAT<br>PROGRAM STUDI ARSITEKTUR UNWIRA</h3>
        </td>
      </tr>
    </tbody>
  </table>
...
$mpdf->WriteHTML('</tr>
  ...
  <tbody>');
$data_prediksi = mysqli_query($conn, "SELECT data_testing.* FROM data_testing JOIN atribut_testing ON data_testing.id_testing=atribut_testing.id_testing WHERE atribut_testing.id_atribut_sub='12' ORDER BY data_testing.id_testing DESC");
